var container, interval, camera, scene, renderer, projector, plane, cube, linesMaterial, color = 0,
	colors = [
	0x1F4FDF, 0xDFAF1F, 0xDF1F1F, 0x80DF1F, 0x1FDF50, 0x1FDFDF, 0x7F1FDF, 0xDF1FAF, 0xEFEFEF, 0x303030],
...
function saveWorld() {
	...
	for (var i in scene.objects) {
		...
		if (object instanceof THREE.Mesh && object !== plane && object !== brush) {
			...
			world[((object.position.x - 25) / 50) + 10][(object.position.y - 25) / 50][((object.position.z - 25) / 50) + 10] = colors.indexOf(object.material[0].color.hex & 0xffffff) + 1;
			console.log([((object.position.x - 25) / 50) + 10, (object.position.y - 25) / 50, ((object.position.z - 25) / 50) + 10]);
		}
	...
	prompt("Level Data:", JSON.stringify(worldFile));
